//! Optional, safe AEAD helpers for sealing adaptor shares with a PVUGC-derived key.
//! HKDF-SHA256 (labeled) + per-message random nonce + transcript/context as AEAD AAD.
