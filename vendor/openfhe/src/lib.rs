...
pub mod ffi
{
    ...
    unsafe extern "C++"
    {
        ...
        type CiphertextStreamReaderDCRTPoly;
        type CiphertextStreamWriterDCRTPoly;
    }
    ...
    // Ciphertext chunk stream helpers
    unsafe extern "C++"
    {
        fn DCRTPolyNewCiphertextStreamReader(path: &CxxString, serialMode: SerialMode)
            -> UniquePtr<CiphertextStreamReaderDCRTPoly>;
        fn DCRTPolyNewCiphertextStreamWriter(path: &CxxString, serialMode: SerialMode, truncate: bool)
