...
fn test_outer_circuit_proof_agnostic() {
    ...
    let proof_inner_1 = Groth16::<InnerE>::prove(&fixture.pk_inner, circuit_inner_1, &mut rng)
    ...
    let proof_inner_2 = Groth16::<InnerE>::prove(&fixture.pk_inner, circuit_inner_2, &mut rng)
